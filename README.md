...
> 🟢 **Start free:** you get **50 requests with no account and no API key**. Just send a request and it works.
...
| `401`       | Free limit reached | You've used your 50 free requests — [get an API key](https://abena.mobobi.com/playground/sdk/dashboard/). |
